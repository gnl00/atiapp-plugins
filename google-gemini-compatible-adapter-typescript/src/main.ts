...
const createTextPart = (text: string) => ({ text })
...
const mapFinishReason = (reason: unknown): IUnifiedResponse['finishReason'] => {
...
const transformToolDefinitions = (tools: ToolDefinition[] | undefined) => {
...
export const geminiRequestAdapter: RequestAdapterHooks = {
  providerType: 'gemini',
  streamProtocol: 'sse',
